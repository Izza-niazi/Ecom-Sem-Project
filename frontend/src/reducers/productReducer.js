...
const emptyRec = { youMayAlsoLike: [], suggestedForYou: [] };

export const productsReducer = (
    state = { products: [], recommendations: emptyRec },
    { type, payload }
) => {
    switch (type) {
        ...
        case HOME_RECOMMENDATIONS_REQUEST:
            return {
                ...state,
                recommendationsLoading: true,
            };
        case HOME_RECOMMENDATIONS_SUCCESS:
            return {
                ...state,
                recommendationsLoading: false,
                recommendations: payload,
            };
        case HOME_RECOMMENDATIONS_FAIL:
            return {
                ...state,
                recommendationsLoading: false,
                recommendations: state.recommendations || emptyRec,
            };
