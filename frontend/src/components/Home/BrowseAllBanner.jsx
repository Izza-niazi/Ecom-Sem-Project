...
const BrowseAllBanner = () => {
    return (
        <div className="mx-auto mt-14 max-w-7xl px-2 sm:mt-6 sm:px-4 md:mt-8">
            <section
                className="fun-noise fun-shimmer relative overflow-hidden rounded-3xl border border-white/15 bg-gradient-to-br from-black via-neutral-950 to-black shadow-2xl shadow-black/40"
            ...
            >
                ...
                <div className="relative flex flex-col gap-6 px-5 py-8 sm:flex-row sm:items-center sm:justify-between sm:px-10 sm:py-10">
                    <div className="flex max-w-xl flex-col gap-3">
                        <span className="inline-flex w-fit items-center gap-2 rounded-full border border-white/20 bg-neutral-950/80 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-neutral-300 shadow-sm shadow-black/30">
                            <GridViewRoundedIcon sx={{ fontSize: 16 }} className="!text-neutral-400" />
                            Full catalog
                        </span>
                        <h2
                    ...
                    <Link
                        to="/products"
                        className="btn-primary group shrink-0 self-start sm:self-center"
                    >
                        Browse all products
                        <ArrowForwardIcon
                            sx={{ fontSize: 20 }}
