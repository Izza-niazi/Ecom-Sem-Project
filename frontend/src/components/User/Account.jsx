...
const Account = () => {
    ...
    return (
        <>
            <MetaData title={metaTitle('My Profile')} />
                ...
                <>
                    ...
                    <main className="w-full mt-12 sm:mt-0">
                        ...
                        <div className="flex gap-3.5 sm:w-11/12 sm:mt-4 m-auto mb-7">
                            ...
                            {/* <!-- details column --> */}
                            <div className="flex-1 overflow-hidden shadow bg-app-card">
                                {/* <!-- edit info container --> */}
                                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                                    ...
                                    <div className="flex flex-col gap-4 mt-4">
                                        ...
                                        <h4 className="text-sm font-medium">When will my {APP_NAME} account be updated with the new email address (or mobile number)?</h4>
                                        ...
                                        <h4 className="text-sm font-medium">What happens to my existing {APP_NAME} account when I update my email address (or mobile number)?</h4>
                                        ...
                                        <p className="text-sm">{APP_NAME} uses a single sign-on policy. Changes may reflect across linked seller tools.</p>
