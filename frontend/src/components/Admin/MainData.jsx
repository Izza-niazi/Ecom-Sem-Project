...
// Registers scales (category, linear) and elements (arc, line, bar) for Chart.js v3+
...
const MainData = () => {
    ...
    return (
        <>
            <MetaData title={`Admin Dashboard | ${APP_NAME}`} />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-6">
                <div className="flex flex-col bg-purple-600 text-white gap-2 rounded-xl shadow-lg hover:shadow-xl p-6">
                    ...
                    <h2 className="text-2xl font-bold">{formatRs(totalAmount ?? 0)}</h2>
                </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-8 min-w-full">
                <div className="bg-app-card rounded-xl h-auto w-full shadow-lg p-2">
                    <Line data={lineState} />
                </div>

                <div className="bg-app-card rounded-xl shadow-lg p-4 text-center">
                    <span className="font-medium uppercase text-slate-300">Order Status</span>
                    <Pie data={pieState} />
                </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-8 min-w-full mb-6">
                ...
                <div className="bg-app-card rounded-xl shadow-lg p-4 text-center">
                    <span className="font-medium uppercase text-slate-300">Stock Status</span>
