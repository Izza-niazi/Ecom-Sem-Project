...
const UpdateOrder = () => {
    ...
    return (
        <>
            <MetaData title={metaTitle('Admin: Update Order')} />
                ...
                <>
                    {order && order.user && order.shippingInfo && (
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col sm:flex-row bg-app-card shadow-lg rounded-lg min-w-full">
                            ...
                            {order.orderItems && order.orderItems.map((item) => {
                                ...
                                return (
                                    <div className="flex flex-col sm:flex-row min-w-full shadow-lg rounded-lg bg-app-card px-2 py-5" key={_id}>
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:w-1/2 gap-1">
                                            ...
                                            <div className="flex flex-col gap-1 overflow-hidden">
                                                ...
                                                <p className="text-xs text-gray-600">Price: {formatRs(price)}</p>
                                                <span className="font-medium">Total: {formatRs(quantity * price)}</span>
                                            </div>
                                        </div>
