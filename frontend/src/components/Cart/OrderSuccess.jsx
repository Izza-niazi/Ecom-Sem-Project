...
const OrderSuccess = ({ success }) => {
    ...
    return (
        <>
            <MetaData title={metaTitle(`Transaction ${success ? 'successful' : 'failed'}`)} />

            <main className="w-full mt-20">

                {/* <!-- row --> */}
                <div className="flex flex-col gap-2 items-center justify-center sm:w-4/6 sm:mt-4 m-auto mb-7 bg-app-card shadow rounded p-6 pb-12">
