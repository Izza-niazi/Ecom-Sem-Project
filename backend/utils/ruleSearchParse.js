...
const CATEGORY_ALIASES = [
  {
    words: ["shoe", "shoes", "sneaker", "sneakers", "boot", "boots", "sandals"],
    category: "Fashion",
  },
  {
    words: ["shirt", "dress", "jeans", "jacket", "clothing", "apparel"],
    category: "Fashion",
  },
  { words: ["laptop", "laptops", "notebook", "macbook"], category: "Laptops" },
  {
    words: ["phone", "phones", "mobile", "mobiles", "smartphone", "iphone"],
    category: "Mobiles",
  },
  {
    words: ["headphone", "headphones", "earbuds", "earphone"],
...
function normalizeSearch(obj) {
  ...
  return {
    ...
    minPrice:
      o.minPrice != null && Number.isFinite(Number(o.minPrice))
        ? Number(o.minPrice)
        : null,
    maxPrice:
      o.maxPrice != null && Number.isFinite(Number(o.maxPrice))
        ? Number(o.maxPrice)
        : null,
    minRating:
...
function buildReplyFromSearch(search) {
  ...
  if (search.maxPrice != null)
    parts.push(`under PKR ${Math.round(search.maxPrice)}`);
  if (search.minPrice != null)
    parts.push(`from PKR ${Math.round(search.minPrice)}`);
