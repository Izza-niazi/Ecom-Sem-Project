# izzmarket — MERN
Full-stack ecommerce with an admin dashboard, Paytm payment flow, and a dark-themed storefront.
...
**Uploads:** Images are stored on disk under `backend/uploads/` and served at `/uploads/...` (no third-party storage).
